...
void ui_Weather_screen_init(void)
{
    ...
    lv_obj_set_x(ui_Cloud, 102);
    lv_obj_set_y(ui_Cloud, 56);
    ...
    lv_obj_set_x(ui_Celsius, -97);
    lv_obj_set_y(ui_Celsius, 54);
    ...
    ui_ = lv_img_create(ui_Weather_Icons);
    lv_img_set_src(ui_, &ui_img_weather_2_png);
    lv_obj_set_width(ui_, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_, -74);
    lv_obj_set_y(ui_, 3);
    lv_obj_set_align(ui_, LV_ALIGN_TOP_MID);
    lv_obj_add_flag(ui_, LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
    lv_obj_clear_flag(ui_, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_img_recolor(ui_, lv_color_hex(0x293062), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_img_recolor_opa(ui_, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_w3, -186);
    lv_obj_set_y(ui_w3, 4);
    ...
    lv_obj_set_x(ui_W2_Num, -16);
    lv_obj_set_y(ui_W2_Num, 26);
