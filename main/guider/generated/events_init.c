...
static void screen_menu_imgbtn_music_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.screen_music, guider_ui.screen_music_del, &guider_ui.screen_menu_del, setup_scr_screen_music, LV_SCR_LOAD_ANIM_NONE, 200, 200, true, true);
        break;
    }
    default:
        break;
