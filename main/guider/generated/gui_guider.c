...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->screen_timer_del = true;
    ui->screen_i2c_del = true;
    ui->screen_recorder_del = true;
    ui->screen_calendar_del = true;
    ui->screen_alarmclock_del = true;
    ui->screen_weather_del = true;
    ui->screen_update_del = true;
    ui->screen_chat_del = true;
    ui->screen_inforeader_del = true;
    ui->screen_setting_network_del = true;
    ui->screen_setting_bkl_del = true;
    ui->screen_setting_sound_del = true;
    ui->screen_setting_webserver_del = true;
    ui->screen_setting_time_del = true;
    ui->screen_setting_sleep_del = true;
    ui->screen_setting_ai_del = true;
    ui->screen_setting_about_del = true;
...
void init_keyboard(lv_ui *ui)
{
    ...
    lv_obj_set_style_text_font(ui->g_kb_top_layer, &lv_font_D_DIN_PRO_700_Bold_18, LV_PART_MAIN|LV_STATE_DEFAULT);
}
